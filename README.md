...
<ol>
    ...
    Seguidamente debemos contar con un sistema de control de versiones (VCS) registrar todos los cambios que se realizan en el proyecto, guardando a su vez versiones anteriores del proyecto, versiones a las que podemos acudir en caso de que no funcionen de la forma correcta,etc.<br>  Git es un sistema de control de versiones de código abierto con arquitectura distribuida, es decir que, en lugar de guardar todos los cambios de un proyecto en un único sitio, cada usuario tiene una copia del repositorio con el historial de cambios completo, aumentando su rendimiento.</br> Para instalar e iniciar con su utilización ingrese aquí https://bluuweb.github.io/tutorial-github/guia/    o en el link oficial https://git-scm.com/ 
    <li> "</li>
    <li>punto tres</li>
   </ol>
   <div
...
<ul>
 ...
 <br>
    ...
    correo: marceloutnfrr@hotmail.com</a></li>
 <br>
